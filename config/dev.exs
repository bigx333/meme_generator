...
config :meme_generator, MemeGeneratorWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:meme_generator, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:meme_generator, ~w(--watch)]}
  ]
...
config :meme_generator, MemeGeneratorWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/meme_generator_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]
